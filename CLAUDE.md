...
REST API (Spring Boot / Kotlin) for the footballproject platform — football data, betting odds, and analytical insights, consumed by the web frontend and mobile app.
