...
import org.footballproject.datamanipulation.livecharts.ControlChartManipulation
import org.footballproject.datamanipulation.livecharts.GoalThreatChartManipulation
import org.footballproject.datamanipulation.livecharts.MomentumChartManipulation
...
import org.footballproject.model.MomentumBaseline
...
class LiveChartsServiceTest {
    ...
    private fun liveFixture(
        ...
        LiveFixtureResponse(
            fixture = Fixture(
                id = fixtureId,
                status = org.footballproject.clientData.MatchStatus(short = statusShort, elapsed = minute)
            ),
