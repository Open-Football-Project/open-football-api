...
class OleNewsDataTest {

    private fun loadXmlFromResource(): Element {
        val stream = this::class.java.getResourceAsStream("/newsfeeds/ole.xml")
            ?: throw IllegalArgumentException("Resource not found: /newsfeed/ole.xml")
    ...
    @Test
    fun `test Ole parser with sample XML`() {
        val parser = OleNewsData()
