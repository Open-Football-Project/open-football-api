...
class GuardianNewsDataTest {

    private fun loadXmlFromResource(): Element {
        val stream = this::class.java.getResourceAsStream("/newsfeeds/guardian.xml")
            ?: throw IllegalArgumentException("Resource not found: /newsfeed/guardian.xml")
    ...
    @Test
    fun `test Guardian parser with sample XML`() {
        val parser = GuardianNewsData()
