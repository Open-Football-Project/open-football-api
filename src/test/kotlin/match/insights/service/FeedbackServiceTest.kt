...
class FeedbackServiceTest {
    ...
    private val props = EmailFeedbackProps(
        from = "sender@futballero.com",
        recipients = setOf("owner@gmail.com", "contact@futballero.com")
    )
    ...
    fun shouldSendEmailWithAllRecipientsOnFeedbackSubmission() {
        ...
        assertThat(captured.captured.to).containsExactlyInAnyOrder("owner@gmail.com", "contact@futballero.com")
    }
    ...
    fun shouldSendEmailFromConfiguredSender() {
        ...
        assertThat(captured.captured.from).isEqualTo("sender@futballero.com")
    }
