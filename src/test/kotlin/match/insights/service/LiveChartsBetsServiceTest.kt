...
import match.insights.clientData.LiveOddsValue
...
import match.insights.repository.LiveChartsBetsRepository
...
class LiveChartsBetsServiceTest {
    ...
    private fun fixture(fixtureId: Int = 1539007, minute: Int = 23) = LiveFixtureResponse(
        fixture = Fixture(
            id = fixtureId,
            status = MatchStatus(short = match.insights.model.MatchStatus.FIRST_HALF.code, elapsed = minute)
        ),
